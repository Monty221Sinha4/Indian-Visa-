...
namespace VisaSystem.Controllers
{
    public class VisaStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StatusID,VisaStatus")] VisaStatu visaStatu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StatusID,VisaStatus")] VisaStatu visaStatu)
        {
            if (ModelState.IsValid)
            {
